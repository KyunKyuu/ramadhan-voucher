    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="sidebar-transition fixed md:static inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-teal-700 to-teal-900 text-white flex flex-col">
            ...
            <nav class="flex-1 px-3 py-3 space-y-0.5 overflow-y-auto">
                ...
                <!-- Finance Section -->
                <div class="pt-4">
                    <p class="px-4 text-xs font-semibold text-teal-300 uppercase tracking-wider mb-2">Finance</p>
                    <a href="{{ route('admin.fund-verification.index') }}" class="flex items-center space-x-2 px-3 py-2 text-sm rounded-lg hover:bg-teal-600 transition {{ request()->routeIs('admin.fund-verification.*') ? 'bg-teal-600' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="font-medium">Verifikasi Dana</span>
                    </a>
                </div>
