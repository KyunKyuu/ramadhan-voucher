        ...
        <form action="{{ route('admin.merchants.update', $merchant) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="google_maps_link" id="google_maps_link" value="{{ old('google_maps_link', $merchant->google_maps_link) }}"
                ...
                <div>
                    ...
                    <input type="text" name="admin_phone" id="admin_phone" value="{{ old('admin_phone', $merchant->admin_phone) }}"
